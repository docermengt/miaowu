...
public class Order {
    ...
    public Order(String order_id, long user_id, long schedule_id, String order_position, int order_state, int order_price, Date order_time, User order_user, Schedule order_schedule) {
